          ...
          <div className="p-4 space-y-4">
            ...
            <div className="text-xs text-slate-500 space-y-1 pt-2 border-t">
              ...
              <div className="grid grid-cols-2 gap-1">
                <span><code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">!!</code> High priority</span>
                <span><code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">@today</code> Due today</span>
                <span><code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">#rock</code> Link to rock</span>
                <span><code className="bg-slate-100 dark:bg-slate-800 px-1 rounded">@3days</code> Due in 3 days</span>
              </div>
            </div>
    ...
    <>
      ...
      {open && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          />
          <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-slate-900 rounded-t-2xl p-4 space-y-3 animate-slide-up">
            <div className="flex items-center gap-2">
              <Input
                value={input}
                onChange={(e) => setInput(e.target.value)}
