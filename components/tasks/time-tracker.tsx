        ...
        {isTracking ? (
          <>
            <div className="flex-1 flex items-center gap-3">
              <div className="flex items-center gap-2 bg-red-50 dark:bg-red-950 text-red-700 dark:text-red-300 px-3 py-2 rounded-lg">
...
function TimeEntryRow({
  ...
  return (
    <div className="flex items-center gap-2 p-2 rounded-lg bg-slate-50 dark:bg-slate-800 group">
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Badge
            ...
            className={cn(
              "text-xs",
              isTracking && "bg-red-50 text-red-700 border-red-200 dark:bg-red-950 dark:text-red-300",
              className
            )}
          >
            {isTracking && (
