...
function Input({ className, type, ...props }: React.ComponentProps<'input'>) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        'h-10 w-full min-w-0 rounded-lg border border-slate-200 bg-white px-4 py-2 text-base shadow-sm transition-all duration-150 ease-out outline-none md:text-sm',
