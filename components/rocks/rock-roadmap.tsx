  ...
  return (
    <Card className={cn("overflow-hidden", className)}>
      ...
      <CardContent className="p-0">
        {/* Timeline Header */}
        <div className="border-b bg-slate-50 dark:bg-slate-900 px-4 py-2">
          <div className="flex">
            ...
            Object.entries(rocksByUser).map(([userId, userRocks]) => {
              ...
              return (
                <div key={userId} className="border-b last:border-b-0">
                  <div className="px-4 py-2 bg-slate-100 dark:bg-slate-800 font-medium text-sm text-slate-700 dark:text-slate-300">
                    {member?.name || "Unknown"}
                  </div>
                  {userRocks.map((rock) => (
                    <RoadmapRow
        ...
        {/* Legend */}
        <div className="border-t px-4 py-2 flex items-center gap-4 text-xs text-slate-500 dark:text-slate-400 bg-slate-50 dark:bg-slate-900">
...
function RoadmapRow({
  ...
  return (
    <TooltipProvider>
      <div className="flex items-center px-4 py-2 hover:bg-slate-50 dark:hover:bg-slate-800 border-b last:border-b-0 cursor-pointer group">
        {/* Rock Name */}
        <div className="w-48 shrink-0 pr-4">
          ...
          >
            ...
            <span className="text-sm font-medium text-slate-700 dark:text-slate-300 truncate group-hover:text-blue-600">
              {rock.title}
            </span>
            {hasDependencies && (
