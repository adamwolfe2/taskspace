...
export function WeeklyEODCalendar({
  ...
  return (
    <TooltipProvider>
      <div className="bg-white dark:bg-slate-900 rounded-xl shadow-card p-5">
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <div>
              <h3 className="font-semibold text-slate-900 dark:text-slate-100">Weekly EOD Status</h3>
          ...
          {submittedCount === expectedCount && expectedCount > 0 && (
            <span className="inline-flex items-center gap-1 text-xs font-medium text-emerald-600 bg-emerald-50 dark:bg-emerald-950 dark:text-emerald-400 px-2 py-1 rounded-full">
            ...
            const dayButton = (
              <button
                ...
                className={cn(
                  ...
                  showAsSelected
                    ? "bg-slate-900 dark:bg-slate-100 text-white dark:text-slate-900 ring-2 ring-slate-900 dark:ring-slate-100 ring-offset-2 dark:ring-offset-slate-900"
                    : day.isFuture
                    ...
                    : "bg-red-50 dark:bg-red-950 hover:bg-red-100 dark:hover:bg-red-900 cursor-pointer"
                )}
              >
                <span
                  className={cn(
                ...
                <Tooltip key={day.date}>
                  ...
                  <TooltipContent side="top" className="max-w-xs p-3">
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-slate-400 pt-1 border-t dark:border-slate-700">
