      ...
      >
        {enabledWidgets.map((widget) => (
          <div
            key={widget.id}
            className={cn(
              "bg-white dark:bg-slate-900 rounded-lg border shadow-sm overflow-hidden",
              isEditing && "ring-2 ring-blue-200 dark:ring-blue-800"
            )}
          >
            {isEditing && (
              <div className="widget-drag-handle flex items-center justify-between px-3 py-1.5 bg-slate-50 dark:bg-slate-800 border-b cursor-move">
