  ...
  const actions: QuickAction[] = [
    {
      ...
      bgColor: hasSubmittedEOD ? "bg-green-50 dark:bg-green-950" : "bg-blue-50 dark:bg-blue-950",
      hoverColor: hasSubmittedEOD ? "hover:bg-green-100 dark:hover:bg-green-900" : "hover:bg-blue-100 dark:hover:bg-blue-900",
      onClick: onSubmitEOD,
      ...
      ? [
          {
            ...
            bgColor: activeFocusSession ? "bg-orange-50 dark:bg-orange-950" : "bg-amber-50 dark:bg-amber-950",
            hoverColor: activeFocusSession ? "hover:bg-orange-100 dark:hover:bg-orange-900" : "hover:bg-amber-100 dark:hover:bg-amber-900",
