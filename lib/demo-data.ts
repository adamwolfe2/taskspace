/**
 * Hardcoded Apple-themed demo data.
...
export const DEMO_ROCKS: Rock[] = [
  {
    ...
    title: "Launch Vision Pro 2.0 SDK",
  ...
  },
  {
    ...
    organizationId: DEMO_ORG_ID,
    workspaceId: DEMO_WORKSPACE_ID,
    title: "Ship Apple Intelligence Phase 3",
    description: "Deploy on-device ML models for advanced Siri, writing tools, and image understanding",
    progress: 85,
    status: "on-track",
    dueDate: "2026-03-31",
    quarter: "Q1 2026",
...
export const DEMO_TASKS: AssignedTask[] = [
  {
    ...
    type: "personal",
    rockId: "rock-1",
    rockTitle: "Launch Vision Pro 2.0 SDK",
    priority: "high",
    dueDate: today,
    status: "in-progress",
    completedAt: null,
  ...
  },
  {
    ...
    organizationId: DEMO_ORG_ID,
    workspaceId: DEMO_WORKSPACE_ID,
    title: "Train Siri intent classifier on new dataset",
    ...
    type: "assigned",
    rockId: "rock-4",
    rockTitle: "Ship Apple Intelligence Phase 3",
    priority: "high",
    dueDate: yesterday,
    status: "completed",
  ...
  },
  {
    ...
    organizationId: DEMO_ORG_ID,
    workspaceId: DEMO_WORKSPACE_ID,
    title: "Write API reference for Vision Pro SDK",
  ...
  },
  {
    ...
    description: "Measure on-device inference times on A18 and M4 chips",
    assigneeId: "demo-user-6",
    assigneeName: "Elena Rodriguez",
...
export const DEMO_EOD_REPORTS: EODReport[] = [
  // Adam Wolfe - yesterday
  {
    ...
    date: yesterday,
    tasks: [
      { id: "et1", text: "Reviewed 3 architecture proposals for Vision Pro SDK spatial APIs", rockId: "rock-1", rockTitle: "Launch Vision Pro 2.0 SDK" },
    ...
    tomorrowPriorities: [
      { id: "ep1", text: "Finalize hand-tracking API surface area", rockId: "rock-1", rockTitle: "Launch Vision Pro 2.0 SDK" },
  ...
  // Adam Wolfe - two days ago
  {
    ...
    challenges: "",
    tomorrowPriorities: [
      { id: "ep3", text: "Review SDK architecture proposals", rockId: "rock-1", rockTitle: "Launch Vision Pro 2.0 SDK" },
    ],
    needsEscalation: false,
    escalationNote: null,
    metricValueToday: null,
  ...
  // Priya Patel - yesterday
  {
    ...
    date: yesterday,
    tasks: [
      { id: "et16", text: "Updated SDK launch project timeline with new sprint data", rockId: "rock-1", rockTitle: "Launch Vision Pro 2.0 SDK" },
      { id: "et17", text: "Wrote 12 API reference pages for Vision Pro SDK", rockId: "rock-7", rockTitle: "Launch developer documentation portal" },
  ...
  // Elena Rodriguez - yesterday
  {
    ...
    date: yesterday,
    tasks: [
      { id: "et24", text: "Completed training run for Siri intent classifier - 4.2% accuracy improvement", rockId: "rock-4", rockTitle: "Ship Apple Intelligence Phase 3" },
      { id: "et25", text: "Benchmarked inference latency on A18 chip - meeting 50ms target", rockId: "rock-4", rockTitle: "Ship Apple Intelligence Phase 3" },
      { id: "et26", text: "Published internal tech talk on federated learning approach", rockId: null, rockTitle: null },
    ],
    challenges: "",
    tomorrowPriorities: [
      { id: "ep15", text: "Start M4 chip optimization pass", rockId: "rock-4", rockTitle: "Ship Apple Intelligence Phase 3" },
      { id: "ep16", text: "Review writing tools model accuracy metrics", rockId: "rock-4", rockTitle: "Ship Apple Intelligence Phase 3" },
    ],
    needsEscalation: false,
    escalationNote: null,
    metricValueToday: null,
  ...
  // Elena Rodriguez - two days ago
  {
    ...
    date: twoDaysAgo,
    tasks: [
      { id: "et27", text: "Prepared training dataset for Siri classifier (200k labeled samples)", rockId: "rock-4", rockTitle: "Ship Apple Intelligence Phase 3" },
      { id: "et28", text: "Optimized model quantization for on-device deployment", rockId: "rock-4", rockTitle: "Ship Apple Intelligence Phase 3" },
    ],
    challenges: "GPU cluster queue times increasing - may need more capacity",
    tomorrowPriorities: [
      { id: "ep17", text: "Launch training run with new dataset", rockId: "rock-4", rockTitle: "Ship Apple Intelligence Phase 3" },
    ],
    needsEscalation: false,
    escalationNote: null,
    metricValueToday: null,
  ...
  // Adam - three days ago
  {
    ...
    date: threeDaysAgo,
    tasks: [
      { id: "et29", text: "Reviewed SDK beta feedback from 3 partner developers", rockId: "rock-1", rockTitle: "Launch Vision Pro 2.0 SDK" },
  ...
  // Priya - two days ago
  {
    ...
    tasks: [
      ...
      { id: "et32", text: "Ran stakeholder alignment meeting for SDK launch plan", rockId: "rock-1", rockTitle: "Launch Vision Pro 2.0 SDK" },
    ],
    challenges: "",
    tomorrowPriorities: [
      { id: "ep19", text: "Write API reference docs for Vision Pro SDK", rockId: "rock-7", rockTitle: "Launch developer documentation portal" },
    ],
    needsEscalation: false,
    escalationNote: null,
    metricValueToday: null,
...
export const DEMO_CLIENTS: Client[] = [
  {
    ...
    contactEmail: "a.brewer@apple.com",
  ...
  },
  {
    ...
    description: "Services including Apple TV+, Music, News, and Arcade",
    contactName: "Rachel Kim",
    contactEmail: "r.kim@apple.com",
    industry: "Services",
    status: "active",
    tags: ["services", "ai"],
    customFields: {},
  ...
  },
  {
    ...
    contactEmail: "m.torres@apple.com",
...
export const DEMO_PROJECTS: Project[] = [
  {
    ...
    workspaceId: DEMO_WORKSPACE_ID,
    clientId: "client-2",
    clientName: "Apple Developer Relations",
    name: "Vision Pro 2.0 SDK Launch",
  ...
  },
  {
    ...
    workspaceId: DEMO_WORKSPACE_ID,
    clientId: "client-3",
    clientName: "Apple Media Services",
    name: "Apple Intelligence Phase 3",
    description: "On-device ML models for Siri, writing tools, and image understanding",
    status: "active",
    priority: "high",
    progress: 85,
...
export const DEMO_VTO: DemoVTOData = {
  ...
  tenYearTarget: {
    target: "Every Apple device powered by on-device AI, enabling deeply personal and private computing experiences for 2 billion users worldwide",
  },
  marketingStrategy: {
  ...
  threeYearPicture: {
    revenue: "$500B",
    profit: "$130B",
    description: "Apple Intelligence available across all devices. Vision Pro established as the leading spatial computing platform. Services revenue exceeds $120B. Carbon neutral across entire supply chain.",
  },
  oneYearPlan: {
    revenue: "$420B",
    profit: "$110B",
    goals: [
      "Launch Apple Intelligence Phase 3 with on-device ML across all platforms",
      "Ship Vision Pro 2.0 SDK and grow developer ecosystem to 10,000+ spatial apps",
    ...
    seats: [
      {
        ...
        bullets: [
          "Lead Apple Intelligence ML model development",
...
## Key Links
- Vision Pro SDK Documentation: internal-wiki/vp-sdk
- CI/CD Dashboard: builds.internal/dashboard
- Crash Analytics: sentry.internal/apple-eng
- Design System: figma.com/apple-design-system

## Q1 2026 Focus Areas
- Ship Vision Pro 2.0 SDK to GA
- Reduce crash rate to <0.1%
- Complete iOS 20 Settings redesign
- Apple Intelligence Phase 3 deployment
...
export const DEMO_PEOPLE_ASSESSMENTS: DemoPeopleAssessment[] = [
  ...
  },
  {
    ...
    latestNotes: "Apple Intelligence Phase 3 tracking ahead of plan. ML model quality improvements are impressive.",
    updatedAt: twoDaysAgo,
  },
]
  ...
  const insights: ManagerInsight[] = [
    {
      ...
      description: "Apple Intelligence Phase 3 is at 85% with 7 weeks remaining. Consider reassigning capacity to support at-risk rocks.",
      priority: "medium",
      actionable: true,
...
export const DEMO_COMMAND_CENTER: DemoCommandCenterData = {
  ...
  dailyDigest: {
    summary: "Productive day across the team. 5 of 5 team members submitted EOD reports. Key progress on Apple Intelligence Phase 3 and security audit. Settings redesign facing accessibility challenges that need attention.",
    wins: [
      { text: "Fixed memory leak in camera module - 40% reduction in allocations", memberName: "Sarah Chen", memberId: "demo-user-2" },
      { text: "Siri intent classifier improved by 4.2% accuracy", memberName: "Elena Rodriguez", memberId: "demo-user-6" },
