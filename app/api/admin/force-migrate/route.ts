...
export const POST = withAdmin(async (request: NextRequest, auth) => {
  ...
  } catch (e) { results.meetings_error = -1 }
  ...
  } catch (e) { results.focus_blocks_error = -1 }
  ...
  } catch (e) { results.daily_energy_error = -1 }
  ...
  } catch (e) { results.user_streaks_error = -1 }
  ...
  } catch (e) { results.focus_score_history_error = -1 }
