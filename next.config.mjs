        ...
        headers: [
          ...
          // Content Security Policy (strict in production, relaxed in development)
          {
            ...
            value: [
              ...
              "connect-src 'self' https://api.resend.com https://*.vercel.com wss://*.vercel.com https://api.anthropic.com https://*.ingest.sentry.io https://*.posthog.com https://*.i.posthog.com",
